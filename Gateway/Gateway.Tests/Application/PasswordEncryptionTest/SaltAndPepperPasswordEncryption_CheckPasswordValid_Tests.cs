...
{
    public class SaltAndPepperPasswordEncryption_CheckPasswordValid_Tests : BaseSaltAndPepperPasswordEncryptionTest
    {
        [Fact]
        ...
        [Fact]
        public void CheckPasswordValid_EmptyPassword_ShouldBeInvalid()
        {
            // Arrange
